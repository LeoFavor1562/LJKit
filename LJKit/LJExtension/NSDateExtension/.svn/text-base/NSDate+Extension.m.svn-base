...
- (NSUInteger)daysAfter {
    return [NSDate daysAfter:self];
}

+ (NSUInteger)daysAfter:(NSDate *)date {
    NSCalendar *calendar = [NSCalendar currentCalendar];
...
- (NSString *)trasnformFrom:(NSString *)oldFormat to:(NSString *)newFormat {
    return [self trasnformFrom:oldFormat to:newFormat];
}

+ (NSString *)trasnformDate:(NSString *)dateString From:(NSString *)oldFormat to:(NSString *)newFormat {
    NSDateFormatter *inputFormatter = [[NSDateFormatter alloc] init];
